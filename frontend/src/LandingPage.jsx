        ...
        <main>
          <section className="grid lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] gap-8 items-stretch mb-16 mt-6">
            <div className="tropical-card hero-glass p-7 lg:p-9 relative overflow-hidden">
              ...
              <h1 className="hero-title text-[28px] sm:text-[32px] lg:text-[38px] leading-tight text-sky-950 mb-4">
                ...
                <span className="block hero-highlight">for the Bali area only.</span>
              </h1>

              <p className="text-sm sm:text-base text-sky-900/80 mb-6 max-w-xl">
                Yudi's Pool helps villa, resort, and private homeowners in Bali keep their pools crystal clear, safe, and
                beautiful  from new pool design and construction to regular maintenance and leak repairs.
              </p>
          ...
          <section id="services" className="mb-16">
            <div className="flex items-center justify-between gap-4 mb-6">
              <div>
                <h2 className="section-title text-xl sm:text-2xl text-sky-950 mb-1">Yudi's Pool Services</h2>
                <p className="text-sm text-sky-900/80 max-w-xl">
                  Choose the right service for your Bali pool – from regular cleaning to new pool construction and
                  full repairs.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] gap-7 items-start">
              <div className="tropical-card p-6 md:p-7">
                ...
                <p className="text-sm text-sky-900/80 mb-5 max-w-xl">
                  Tell us about your pool condition, location, and main needs. We’ll recommend the most suitable
                  cleaning, construction, or repair package.
                </p>
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-medium text-sky-950 mb-1 block">Full name</label>
                      <Input
                        required
                        value={form.name}
